...
def main():
    ...
    parser.add_argument('--train_condition', '-tc', type=str,
                        choices=['toy_test',
                                 'coordinate_input',
                                 'center_pixel_input',
                                 'real_time_play',
                                 'multiframe_pred'],
                        default='center_pixel_input',
                        help='train_condition: \'toy_test\', '
    ...
    parser.add_argument('--restore_step', '-rs', type=int, default=None,
    ...
    parser.add_argument('--seq_length', '-sl', type=int, default=6,
                        help='sequence length')
    parser.add_argument('--gaussian_dim', '-gd', type=int, default=3,
                        help='dimentionality of gaussian distribution')
    parser.add_argument('--features_dim', '-fd', type=int, default=4,
                        help='dimentionality of input features')
    parser.add_argument('--weight_decay', '-wd', type=float, default=0.005,
                        help='scale factor of regularization of neural network')
